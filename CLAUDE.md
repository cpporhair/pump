...
- @ai_spec/SENDERS_SPEC.md — sender语义与注意事项
- @ai_spec/SCHEDULER_SPEC.md — scheduler定义与类型
- @ai_spec/CONCURRENCY_MODEL.md — 并发模型、visit算子
- @ai_spec/PROJECT_AI_SPEC.md — 模块索引、编码关注点
