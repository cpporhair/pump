...
| Scheduler Isolation | 执行域隔离，显式切换(Task/NVMe/TCP/UDP/RPC) |
| Lock-Free | 框架和应用均无锁 |
...
| UDP Scheduler（io_uring / epoll） | `env/scheduler/udp/io_uring/scheduler.hh`, `env/scheduler/udp/epoll/scheduler.hh` |
