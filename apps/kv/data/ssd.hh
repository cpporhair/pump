...
#ifndef APPS_KV_DATA_SSD_HH
#define APPS_KV_DATA_SSD_HH
...
namespace apps::kv::data {
    ...
    ssd {
        ...
        uint64_t                    max_sector;
        pump::scheduler::nvme::ssd<data_page>* nvme_dev;
        std::vector<pump::scheduler::nvme::qpair<data_page>*> nvme_qpairs_by_core;
        ...
        ssd()
            ...
            , nvme_dev(nullptr)
            , nvme_qpairs_by_core(std::vector<pump::scheduler::nvme::qpair<data_page>*>(
