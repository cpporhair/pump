...
#ifndef APPS_KV_DATA_DATA_PAGE_HH
#define APPS_KV_DATA_DATA_PAGE_HH

#include <cstring>

#include "../runtime/const.hh"
...
namespace apps::kv::data {
    ...
    make_data_page_payload() {
        return pump::scheduler::nvme::malloc_page(runtime::data_page_size);
    }

    inline
    auto
    free_data_page_payload(void* payload) {
        return pump::scheduler::nvme::free_page(payload);
    }
    ...
    data_page {
        ...
        uint64_t    pos;
        void*       payload;
        const pump::scheduler::nvme::ssd<data_page>* ssd_info;
        ...
        inline
        const pump::scheduler::nvme::ssd<data_page>*
        get_ssd_info() const {
            return ssd_info;
        }
    };
...
#endif //APPS_KV_DATA_DATA_PAGE_HH
