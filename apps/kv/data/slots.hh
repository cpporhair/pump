...
#ifndef APPS_KV_DATA_SLOTS_HH
#define APPS_KV_DATA_SLOTS_HH
...
namespace apps::kv::data {
    ...
    slot_manager {
        ...
        slot_manager(const char *sn,
            uint32_t i,
            const pump::scheduler::nvme::ssd<data_page>* info,
