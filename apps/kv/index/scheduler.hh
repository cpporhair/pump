...
#ifndef APPS_KV_INDEX_SCHEDULER_HH
#define APPS_KV_INDEX_SCHEDULER_HH
...
namespace apps::kv::index {
    ...
    private:
        ...
        pump::scheduler::nvme::req_pool<sizeof(_update::req)> update_req_pool;
        pump::scheduler::nvme::req_pool<sizeof(_cached::req)> cached_req_pool;
        pump::scheduler::nvme::req_pool<sizeof(_getter::req)> getter_req_pool;
        pump::scheduler::nvme::req_pool<sizeof(_tasker::req)> tasker_req_pool;
        pump::scheduler::nvme::req_pool<sizeof(_b_tree::req)> b_tree_req_pool;
    ...
    public:
        scheduler(uint32_t c, data::b_tree* root)
            ...
            , update_req_pool((std::string("index_update_req_pool") + std::to_string(c)).c_str() , runtime::spdk_dma_pool_size)
            , cached_req_pool((std::string("index_cached_req_pool") + std::to_string(c)).c_str() , runtime::spdk_dma_pool_size)
            , getter_req_pool((std::string("index_getter_req_pool") + std::to_string(c)).c_str() , runtime::spdk_dma_pool_size)
            , tasker_req_pool((std::string("index_tasker_req_pool") + std::to_string(c)).c_str() , runtime::spdk_dma_pool_size)
            , b_tree_req_pool((std::string("index_b_tree_req_pool") + std::to_string(c)).c_str() , runtime::spdk_dma_pool_size) {
        }
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, apps::kv::index::_update::sender<scheduler_t>> {
        ...
        get_value_type_identity() {
            static_assert(count_value() !=0, "count_value() must not be 0");
        }
    };

    template <typename context_t, typename scheduler_t>
    struct
    compute_sender_type<context_t, apps::kv::index::_cached::sender<scheduler_t>> {
        consteval static auto
        count_value() {
            return 0;
        }
    ...
    template <typename context_t, typename scheduler_t>
    struct
    compute_sender_type<context_t, apps::kv::index::_b_tree::sender<scheduler_t>> {
        consteval static auto
        count_value() {
            return 1;
        }
        consteval static auto
        get_value_type_identity() {
            return std::type_identity<apps::kv::data::b_tree*>{};
        }
    };

    template <typename context_t, typename scheduler_t>
    struct
    compute_sender_type<context_t, apps::kv::index::_getter::sender<scheduler_t>> {
        consteval static auto
        count_value() {
            return 1;
        }
        consteval static auto
        get_value_type_identity() {
            return std::type_identity<apps::kv::index::_getter::result_type>{};
        }
    };

    template <typename context_t, typename scheduler_t>
    struct
    compute_sender_type<context_t, apps::kv::index::_tasker::sender<scheduler_t>> {
        consteval static auto
        count_value() {
            return 0;
        }
...
#endif //APPS_KV_INDEX_SCHEDULER_HH
