...
#ifndef ENV_SCHEDULER_KCP_SENDERS_ACCEPT_HH
#define ENV_SCHEDULER_KCP_SENDERS_ACCEPT_HH
...
namespace pump::scheduler::kcp::senders::accept {

    template <typename scheduler_t>
    struct
    op {
        constexpr static bool kcp_sender_accept_op = true;
        ...
        start(context_t& context, scope_t& scope) {
            return scheduler->schedule(
                new common::accept_req{
                    [context = context, scope = scope](common::conv_id_t conv) mutable {
...
namespace pump::core {
    ...
    requires (pos < std::tuple_size_v<typename scope_t::element_type::op_tuple_type>)
        && (get_current_op_type_t<pos, scope_t>::kcp_sender_accept_op)
    struct
    ...
    struct
    compute_sender_type<context_t, scheduler::kcp::senders::accept::sender<scheduler_t>> {
        ...
        get_value_type_identity() {
            return std::type_identity<scheduler::kcp::common::conv_id_t>{};
        }
    };
}

#endif //ENV_SCHEDULER_KCP_SENDERS_ACCEPT_HH
