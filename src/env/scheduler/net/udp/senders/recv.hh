...
#ifndef ENV_SCHEDULER_UDP_SENDERS_RECV_HH
#define ENV_SCHEDULER_UDP_SENDERS_RECV_HH

#include <cstdint>

#include "pump/core/op_pusher.hh"
#include "pump/core/compute_sender_type.hh"
#include "env/scheduler/net/udp/common/struct.hh"
            ...
            return scheduler->schedule(
                new common::recv_req{
                    [context = context, scope = scope](
                        std::variant<std::pair<common::datagram, common::endpoint>, std::exception_ptr>&& res
                    ) mutable {
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, scheduler::udp::senders::recv::sender<scheduler_t>> {
...
#endif //ENV_SCHEDULER_UDP_SENDERS_RECV_HH
