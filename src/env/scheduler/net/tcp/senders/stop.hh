...
namespace pump::scheduler::tcp::senders::stop {
    ...
    op {
        ...
        start(context_t &context, scope_t &scope) {
            return scheduler->schedule_stop(
                new common::stop_req<session_t>{
                    session,
...
namespace pump::core {
    ...
    && (get_current_op_type_t<pos, scope_t>::net_sender_stop_op)
    struct
    ...
    struct
    compute_sender_type<context_t, scheduler::tcp::senders::stop::sender<scheduler_t, session_t>> {
