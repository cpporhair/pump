#ifndef ENV_SCHEDULER_TCP_SENDERS_CONN_HH
#define ENV_SCHEDULER_TCP_SENDERS_CONN_HH
#include <cstdint>
...
namespace pump::scheduler::tcp::senders::conn {
    ...
    op {
        ...
        start(context_t &context, scope_t &scope) {
            return scheduler->schedule(
                new common::conn_req{
                    [context = context, scope = scope](int fd) mutable {
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, scheduler::tcp::senders::conn::sender<scheduler_t>> {
...
#endif //ENV_SCHEDULER_TCP_SENDERS_CONN_HH
