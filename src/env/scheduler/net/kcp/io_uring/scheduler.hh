...
#include "env/scheduler/net/dgram/io_uring.hh"
...
namespace pump::scheduler::kcp::io_uring {
    ...
    private:
        // Per-connection state: ikcp + session
        ...
        core::per_core::queue<common::accept_req*> accept_q{256};
        core::per_core::queue<common::connect_req*> connect_q{256};
    ...
    private:
        ...
        // --- Deliver KCP messages to session's frame_receiver ---
    ...
    public:
        ...
        explicit scheduler(size_t queue_depth)
            : send_q(queue_depth), accept_q(queue_depth), connect_q(queue_depth) {
        }
