...
namespace pump::scheduler::nvme::put {
...
namespace pump::core {
    ...
    && (get_current_op_type_t<pos, scope_t>::nvme_put_data_op)
    struct
    ...
    struct
    compute_sender_type<context_t, scheduler::nvme::put::sender<scheduler_t, page_t>> {
...
#endif //ENV_SCHEDULER_NVME_PUT_PAGE_HH
