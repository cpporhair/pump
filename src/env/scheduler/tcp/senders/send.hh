#ifndef ENV_SCHEDULER_TCP_SENDERS_SEND_HH
#define ENV_SCHEDULER_TCP_SENDERS_SEND_HH
#include <cstdint>
...
namespace pump::scheduler::tcp::senders::send {
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, scheduler::tcp::senders::send::sender<scheduler_t>> {
...
#endif //ENV_SCHEDULER_TCP_SENDERS_SEND_HH
