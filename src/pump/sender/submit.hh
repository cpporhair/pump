#ifndef PUMP_SENDER_SUBMIT_HH
#define PUMP_SENDER_SUBMIT_HH

#include "../core/bind_back.hh"
#include "../core/context.hh"
#include "../core/op_pusher.hh"
#include "../core/op_poller.hh"
    ...
    namespace _submit {
        ...
        fn {
            ...
            operator ()(context_t context, receiver_t&& receiver) const {
                return core::bind_back<fn, context_t, receiver_t>{
                    fn{},
                    context,
                    __fwd__(receiver)
                };
