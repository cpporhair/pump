#ifndef PUMP_SENDER_WHEN_SKIPPED_HH
#define PUMP_SENDER_WHEN_SKIPPED_HH
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, sender::_when_skipped::sender<sender_t, func_t>> {
...
#endif //PUMP_SENDER_WHEN_SKIPPED_HH
