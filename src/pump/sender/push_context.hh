    ...
    namespace _push_context {
        ...
        op {
            ...
            get_new_context(context_t& context) {
                return std::make_shared<::pump::core::pushed_context<push_compile_id, context_t, content_t...>>(context, __mov__(contents));
            }
            ...
            get_new_context(context_t& context, values_t&& ...v) {
                return std::make_shared<::pump::core::pushed_context<push_compile_id, context_t, values_t...>>(
                    context,
