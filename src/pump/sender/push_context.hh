#ifndef PUMP_SENDER_PUSH_CONTEXT_HH
#define PUMP_SENDER_PUSH_CONTEXT_HH
    ...
    namespace _push_context {
        ...
        op {
            ...
            get_new_context(context_t& context) {
                using ctx_t = ::pump::core::pushed_context<push_compile_id, context_t, content_t...>;
                return ::pump::core::context_ptr<ctx_t>(new ctx_t(context, __mov__(contents)));
            }
            ...
            get_new_context(context_t& context, values_t&& ...v) {
                using ctx_t = ::pump::core::pushed_context<push_compile_id, context_t, values_t...>;
                return ::pump::core::context_ptr<ctx_t>(new ctx_t(
                    context,
        ...
        fn {
            ...
            operator ()(content_t&& ...content) const {
                ...
                return core::bind_back<fn2<compile_id>, content_t...>(fn2<compile_id>{}, __fwd__(content)...);
            }
        };
    }
    ...
    op_pusher<pos, scope_t> : op_pusher_base<pos, scope_t>  {
        ...
        push_value(context_t& context, scope_t& scope, value_t&& ...v) {
            ...
            if constexpr (op.is_push_value) {
                ...
                auto new_context = op.get_new_context(context, __fwd__(v)...);
                op_pusher<pos + 1, __typ__(scope)>::push_value(new_context, scope);
            }
            else {
                auto new_context = op.get_new_context(context);
                op_pusher<pos + 1, __typ__(scope)>::push_value(new_context, scope, __fwd__(v)...);
            }
        }
...
namespace pump::core {
    ...
    struct
    compute_sender_type<context_t, sender::_push_context::sender<pos, sender_t, content_t...>> {
    ...
    template <typename context_t, uint32_t pos, typename sender_t, typename ...content_t>
    struct
    compute_context_type<context_t, ::pump::sender::_push_context::sender<pos, sender_t, content_t...>> {
        using xxxx = compute_context_type<context_t, sender_t>::type;
        using type = context_ptr<pushed_context<pos, xxxx, content_t...>>;
    };
}

#endif //PUMP_SENDER_PUSH_CONTEXT_HH
